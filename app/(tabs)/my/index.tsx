  ...
  return (
    <AuthRoute>
        ...
        <View style={styles.header}>
          <Image
            source={
              auth.imageUri
                ? {
                    uri: `${Platform.OS === "ios" ? baseUrl.ios : baseUrl.android}/${auth.imageUri}`,
                  }
        ...
        <View style={styles.tabContainer}>
          ...
          <PagerView ref={pagerRef} initialPage={0} style={{flex: 1}} onPageSelected={(e)=>setCurrentTab(e.nativeEvent.position)}>
            <MyFeedList key="1"/>
            <LikedFeedList key="2"/>
          </PagerView>
    </AuthRoute>
